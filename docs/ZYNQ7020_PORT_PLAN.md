...
**★ M4A-1.1a / 1.1b / 1.2a / 1.2b 全部完成 —— 上游 VFS 在板上真的跑起来了：
板上 110 passed / 0 failed，`ninja -f build-arm.ninja arm32` = 40/40、0 个未定义符号
...
**下一步是 M4A-1.3（块设备 + `diskio`）与 1.4（FATFS，先接 RAM 盘）。**
