...
—— 上游 VFS、FATFS、devfs、pipefs 都在板上跑起来了;pty 也已**起搏**(读写往返还没验,见 §4.6):板上 **138 passed / 0 failed**,
