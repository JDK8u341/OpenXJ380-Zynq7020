...
**★ M4A-1.1a / 1.1b / 1.2a / 1.2b / 1.4 全部完成,1.5 的 `dev` 与 `pipe` 也已进图**
...
并由算术反推子类型 FAT12。
**下一步是 M4A-1.5 的其余项(`pty`、`pipe` 自己的往返自检)与 M4A-1.3(真实块设备 SD/arasan)。**
